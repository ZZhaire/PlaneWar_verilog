...
HD_PWD='D:/verilog_projects/test090_plane_war/test090_plane_war.runs/rom_end_image_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_end_image.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_end_image.tcl
